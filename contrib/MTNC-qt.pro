...
RESOURCES += src/qt/MTNC.qrc src/qt/MTNC_locale.qrc

TRANSLATIONS += src/qt/locale/MTNC_bg.ts \
                src/qt/locale/MTNC_de.ts \
                src/qt/locale/MTNC_en.ts \
                src/qt/locale/MTNC_es.ts \
                src/qt/locale/MTNC_fi.ts \
                src/qt/locale/MTNC_fr.ts \
                src/qt/locale/MTNC_it.ts \
                src/qt/locale/MTNC_ja.ts \
                src/qt/locale/MTNC_pl.ts \
                src/qt/locale/MTNC_pt.ts \
                src/qt/locale/MTNC_ru.ts \
                src/qt/locale/MTNC_sk.ts \
                src/qt/locale/MTNC_sv.ts \
                src/qt/locale/MTNC_vi.ts \
                src/qt/locale/MTNC_zh_CN.ts \
                src/qt/locale/MTNC_zh_TW.ts
