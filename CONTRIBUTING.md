Contributing to MTNC Core
============================

The MTNC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MTNC Core project, and is not to be
confused with overall MTNC Network Protocol consensus changes.

Whether a pull request is merged into MTNC Core rests with the project merge
...
Patches that change MTNC consensus rules are considerably more involved than
...
Where a patch set proposes to change the MTNC consensus, it must have been
...
The project leader is the release manager for each MTNC Core release.
