...
public:
    ...
    void setZMTNCControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzMTNC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzMTNC_clicked();
    void on_pushButtonZMTNCControl_clicked();
