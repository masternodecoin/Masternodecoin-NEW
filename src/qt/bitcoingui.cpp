...
const std::string VERSION_CHECK_SERVER = "www.MTNC.live";
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MTNC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MTNC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MTNC: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMTNC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MTNC Core"), this);
    aboutAction->setStatusTip(tr("Show information about MTNC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MTNC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MTNC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MTNC addresses"));
    ...
    openAction->setStatusTip(tr("Open a MTNC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MTNC Core help message to get a list with possible MTNC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MTNC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MTNC network", "", count));
}
...
{
    QString strTitle = tr("MTNC Core"); // default title
