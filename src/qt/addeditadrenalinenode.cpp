    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText(tr("Enter 500000 IC TXID"));
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("Please enter an ip address and port. (123.45.67.89:11186)"), QMessageBox::Ok);
        return;
    }
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("Please enter the transaction hash for the transaction that has 500000 coins"), QMessageBox::Ok);
        return;
    }
    ...
    else
    {
        ...
        QMessageBox::warning(this, tr("Warning"), tr("Finished to add the masternode, please restart the MTNC-qt client"), QMessageBox::Ok);
    }
}
