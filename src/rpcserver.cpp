...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MTNC features */
        {"MTNC", "masternode", &masternode, true, true, false},
        {"MTNC", "listmasternodes", &listmasternodes, true, true, false},
        {"MTNC", "getmasternodecount", &getmasternodecount, true, true, false},
        {"MTNC", "masternodeconnect", &masternodeconnect, true, true, false},
        {"MTNC", "masternodecurrent", &masternodecurrent, true, true, false},
        {"MTNC", "masternodedebug", &masternodedebug, true, true, false},
        {"MTNC", "startmasternode", &startmasternode, true, true, false},
        {"MTNC", "createmasternodekey", &createmasternodekey, true, true, false},
        {"MTNC", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"MTNC", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"MTNC", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"MTNC", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"MTNC", "getmasternodescores", &getmasternodescores, true, true, false},
        {"MTNC", "mnbudget", &mnbudget, true, true, false},
        {"MTNC", "preparebudget", &preparebudget, true, true, false},
        {"MTNC", "submitbudget", &submitbudget, true, true, false},
        {"MTNC", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"MTNC", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"MTNC", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"MTNC", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"MTNC", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"MTNC", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"MTNC", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"MTNC", "checkbudgets", &checkbudgets, true, true, false},
        {"MTNC", "mnsync", &mnsync, true, true, false},
        {"MTNC", "spork", &spork, true, true, false},
        {"MTNC", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"MTNC", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> MTNC-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11185/\n";
}
