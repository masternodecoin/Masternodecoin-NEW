...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MTNC Core MTNC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MTNC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MTNC transaction") + "\n" +
                               "  MTNC-tx [options] -create [commands]   " + _("Create hex-encoded MTNC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MTNC transaction
