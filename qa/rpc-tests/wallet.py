...
#   c) node1 mines 32 blocks, so now node 0 has 60001MTNC, node 1 has 4250MTNC, node2 has none.
#   d) node0 sends 601 MTNC to node2, in two transactions (301 MTNC, then 300 MTNC).
